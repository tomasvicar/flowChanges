...
%     try
    ...
    for cellNum = 1:num_cells
        ...
        saveas(gcf,[path_save info.folder{fileNum} '\Cell' num2str(cellNum) 'CentreDiff.fig'])
        saveas(gcf,[path_save info.folder{fileNum} '\Cell' num2str(cellNum) 'CentreDiff'],'epsc')
    ...
    saveas(gcf,[path_save info.folder{fileNum} '\All_Cells_CentreDiff.fig'])
    saveas(gcf,[path_save info.folder{fileNum} '\All_Cells_CentreDiff'],'epsc')
    close(gcf)
