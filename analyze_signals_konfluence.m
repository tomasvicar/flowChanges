...
for main_folder_num = 1:length(paths)
    ...
    for fileNum = 33:height(opt.info)
        ...
        if fileNum==22%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            flowmeterTimes(63830:end) = 12.5848 + 317.5380 + flowmeterTimes(63830:end) +0.005;
        end
        if fileNum==33%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            flowmeterTimes(144310:end) = 718.0388 + 12.3942 + flowmeterTimes(144310:end) +0.005;
        end
