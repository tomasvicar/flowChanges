...
%     end
    ...
    for cellNum = 1:num_cells
        ...
        for edgeNum = 1:numEdges_used_minus1
            ...
            shift_x = xdata0(1);
            xdata = xdata0 - shift_x;
            
            h = heights_all{cellNum}(edgeNum);
            ydata = (WCdiff(WCextremaPoss(edgeNum):WCextremaPoss(edgeNum+1))/opt.px2mum)/h;
            
            
            xdata2 = flowmeterTimes(flowExtremaPoss(edgeNum):flowExtremaPoss(edgeNum+1));
            shift_x2 = xdata2(1);
            xdata2 = xdata2 - shift_x2;
            
            ydata2 = flowmeterValues(flowExtremaPoss(edgeNum):flowExtremaPoss(edgeNum+1));
